...
def step(fluid_particles, wall_particles, fluid_particle_acceleration, fluid_particle_pressure, wall_particle_pressure, fluid_initial_density, fluid_particle_density, wall_particle_density,
         fluid_particle_mass, \
    ...
    drho_by_dt = calculate_density_derivative(fluid_particles, wall_particles, fluid_particle_density, fluid_particle_pressure, fluid_particle_mass, fluid_initial_density, fluid_Xi,
                                              fluid_adiabatic_exp, fluid_p_0, h, d, r_c, dx)
    ...
    fluid_particle_acceleration = calculate_acceleration(fluid_particles, wall_particles, fluid_particle_density, fluid_particle_pressure, wall_particle_pressure, fluid_particle_mass,
                                                         fluid_initial_density, fluid_Xi, fluid_adiabatic_exp, fluid_p_0, h, d, r_c, dx, fluid_alpha, fluid_c_0, g, n_dt)
...
def main():
    ...
    while n_dt <= 2:  ##Replace with t < t_end once everything is working
        ...
        # *******************************************************************************************
        fluid_particles, wall_particles, fluid_particle_acceleration, fluid_particle_pressure, fluid_particle_density, wall_particle_pressure = step(fluid_particles, wall_particles,
                                                                                                                                                     fluid_particle_acceleration,
                                                                                                                                                     fluid_particle_pressure, wall_particle_pressure,
                                                                                                                                                     fluid_initial_density, fluid_particle_density,
                                                                                                                                                     wall_particle_density, fluid_particle_mass, \
                                                                                                                                                     fluid_adiabatic_exp, fluid_c_0, fluid_p_0,
                                                                                                                                                     fluid_Xi, fluid_alpha, dt, n_dt, d, r_c, h, g, dx)
        # *******************************************************************************************
